  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 p-4 lg:hidden">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="flex h-14 w-full items-center justify-center gap-2 rounded-full bg-primary-green text-base font-bold text-white shadow-2xl shadow-primary-green/40"
